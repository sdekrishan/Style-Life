...
const AdminHome = () => {
  const { spa, restro, health, AdminLoading, user } = useSelector(
    (store) => store.admin
  );
  const {
    isOpen: isRestroOpen,
    onOpen: OnRestroOpen,
    onClose: onRestroClose,
  } = useDisclosure();
  const {
    isOpen: isSpaOpen,
    onOpen: OnSpaOpen,
  ...
  return (
    ...
    >
      <Box
        w={{ base: "80%", sm: "80%", md: "25%" }}
        h="fit-content"
        position={{ base: "static", sm: "static", md: "fixed", lg: "fixed" }}
        className="sidebar"
      >
        <Box display={"flex"} flexDirection="column" h="fit-content">
          <Text fontWeight={"bold"} fontSize="lg" mb="2rem">
            DashBoard
          </Text>
      ...
      >
        ...
        >
          {restValue
            ? restro.length > 0 &&
              restro?.map((el, ind) => <AdminRestro key={ind} Data={el} />)
            : spaValue
            ? spa?.map((el, ind) => <AdminSpa Data={el} key={ind} />)
            : healthValue
            ? health?.map((el, ind) => <AdminHealth key={ind} Data={el} />)
          ...
          <ModalBody>
            ...
            >
              ...
              <Input
                ...
                placeholder="name"
                required
                onChange={(e) => setRestroAddName(e.target.value)}
              />
              ...
              <Input
                ...
                placeholder="name"
                required
                onChange={(e) => setRestroAddAddress(e.target.value)}
              />
              ...
              <Input
                ...
                placeholder="name"
                required
                onChange={(e) => setRestroAddImg(e.target.value)}
              />
              ...
              <Input
                ...
                placeholder="name"
                required
                onChange={(e) => setRestroAddOffers(e.target.value)}
              />
              <Input
                type={"submit"}
                value="Add"
          ...
          <ModalBody>
            ...
            >
              ...
              <Input
                ...
                placeholder="name"
                required
                onChange={(e) => setSpaAddName(e.target.value)}
              />
              <label htmlFor="">Address</label>
              <Input
                type="text"
                placeholder="name"
                required
                onChange={(e) => setSpaAddAddress(e.target.value)}
              />
              <label htmlFor="">Image</label>
              <Input
                type="text"
                placeholder="name"
                required
                onChange={(e) => setSpaAddImg(e.target.value)}
              />
              ...
              <Input
                ...
                placeholder="name"
                required
                onChange={(e) => setSpaAddOffers(e.target.value)}
              />
              <Input
                type={"submit"}
                value="Add"
          ...
          <ModalBody>
            ...
            >
              ...
              <Input
                ...
                placeholder="name"
                required
                onChange={(e) => setHealthAddName(e.target.value)}
              />
              <label htmlFor="">Address</label>
              <Input
                type="text"
                placeholder="name"
                required
                onChange={(e) => setHealthAddAddress(e.target.value)}
              />
              <label htmlFor="">Image</label>
              <Input
                type="text"
                placeholder="name"
                required
                onChange={(e) => setHealthAddImg(e.target.value)}
              />
              <label htmlFor="">Category</label>
              <Input
                type="text"
                placeholder="name"
                required
                onChange={(e) => setHealthAddOffers(e.target.value)}
              />
              <Input
                type={"submit"}
                value="Add"
