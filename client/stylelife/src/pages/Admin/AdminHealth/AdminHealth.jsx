...
import { DelHealth, UpdateHealth } from "../../../Redux/Admin/AdminTypes";
import "./AdminHealth.scss";
const AdminHealth = ({ Data }) => {
  const {
    isOpen: isUpdateOpen,
    onOpen: OnUpdateOpen,
  ...
  const handleSubmit = (id) => {
    ...
    dispatch(UpdateHealth(payload, id));
  };
  return (
    <>
      {" "}
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            >
              ...
              <Input
                onChange={(e) => setUpdateOffers(e.target.value)}
                type="text"
                placeholder="name"
              />
